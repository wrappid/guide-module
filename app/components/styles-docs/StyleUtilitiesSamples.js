import {
  CoreAlert, CoreBox, CoreClasses, CoreList, CoreListItem, CoreTypographyBody1, CoreTypographyBody2, CoreTypographyCaption 
} from "@wrappid/core";
  ...
  renderElement: (key, classes, className) => {
    return (
      <CoreBox
        ...
        styleClasses={[classes[className], CoreClasses.BORDER.BORDER, CoreClasses.PADDING.P1, CoreClasses.TEXT.TEXT_CENTER]}
      >
    ...
    renderElement: (key, classes, className) => {
      return (
        <CoreBox
          ...
          styleClasses={[CoreClasses.BG.BG_WARNING_LIGHT, CoreClasses.BORDER.BORDER, CoreClasses.BORDER.BORDER_WARNING, CoreClasses.TEXT.TEXT_CENTER]}
        >
    ...
    renderElement: (key, classes, className) => {
      return (
        <CoreBox
          ...
          styleClasses={[CoreClasses.BORDER.BORDER, CoreClasses.PADDING.P1, CoreClasses.TEXT.TEXT_CENTER, classes[className]]}
        >
          <CoreTypographyCaption>{className}</CoreTypographyCaption>
        </CoreBox>
      );
    ...
    renderElement: (key, classes, className) => {
      return (
        <CoreBox
          ...
          gridProps={{ gridSize: 3 }}
          styleClasses={[
            CoreClasses.BG.BG_SECONDARY_LIGHT, classes[className], CoreClasses.ALIGNMENT.JUSTIFY_CONTENT_CENTER, CoreClasses.PADDING.P1
            // CoreClasses.BORDER.BORDER,
            // CoreClasses.BORDER.BORDER_2,
          ]}
        >
